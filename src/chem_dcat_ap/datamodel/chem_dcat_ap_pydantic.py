...
class MaterialisticMixin(ConfiguredBaseModel):
    ...
    has_temperature: Optional[list[Temperature]] = Field(default=None, description="""The slot to provide the Temperature of a MaterialEntity.""", json_schema_extra = { "linkml_meta": {'domain_of': ['MaterialisticMixin', 'ChemicalReaction'],
    ...
    has_density: Optional[list[Density]] = Field(default=None, description="""The slot to provide the Density of a MaterialEntity.""", json_schema_extra = { "linkml_meta": {'domain_of': ['MaterialisticMixin'],
         ...
         'recommended': True,
         'slot_uri': 'SIO:000008'} })
    has_pressure: Optional[list[Pressure]] = Field(default=None, description="""The slot to provide the Pressure of a MaterialEntity.""", json_schema_extra = { "linkml_meta": {'domain_of': ['MaterialisticMixin', 'ChemicalReaction'],
         'is_a': 'has_quantitative_attribute',
         'recommended': True,
         'slot_uri': 'SIO:000008'} })
...
class ChemicalReaction(EvaluatedActivity):
    ...
    used_starting_material: Optional[list[StartingMaterial]] = Field(default=None, description="""The slot to specify the Reagent(s) of a ChemicalReaction.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ChemicalReaction'],
         'is_a': 'had_input_entity',
         'recommended': True,
         'slot_uri': 'RO:0004009'} })
    used_reactant: Optional[list[Reagent]] = Field(default=None, description="""The slot to specify the Reagent(s) of a ChemicalReaction.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ChemicalReaction'],
         ...
         'recommended': True,
         'slot_uri': 'RO:0004009'} })
    generated_product: Optional[list[ChemicalProduct]] = Field(default=None, description="""The slot to specify the Product of a ChemicalReaction.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ChemicalReaction'],
